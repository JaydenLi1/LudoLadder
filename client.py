...
def finishingBox():
    ...
    finishingBox.place(x=screen_width/2-335, y=screen_height/2-300)
...
def gameWindow():
    ...
    player1ScoreLabel = canvas2.create_text(
        400,  screen_height/4 + 80, text=player1Score, font=("Chalkboard SE", 80), fill='#fff176')
    ...
    player2ScoreLabel = canvas2.create_text(
        screen_width - 300, screen_height/4 + 80, text=player2Score, font=("Chalkboard SE", 80), fill='#fff176')
